...
<head>
    ...
    <title>Maria Maika Delmar Lansang Website</title>
...
<body>
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand"><a href="http://startbootstrap.com">Maika's Website!</a>
            </li>
    ...
    <div id="top" class="header">
        <div class="vert-text">
            ...
            <h3>
                <em>I am</em> Maria Maika Delmar Y. Lansang ,
                <em>Are</em> You Interested?</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <h2>In this website, you will learn more about me. Skills, Personality, Hobbies and a lot more</h2>
                    <p class="lead">Maria Maika Delmar Y. Lansang was born in June 27, 1996. She is now 20 years old. She is the youngest among four siblings <br>
                        <a target="_blank" href="http://join.deathtothestockphoto.com/"> Maika.com</a></p>
                </div>
            </div>
        </div>
    </div>
